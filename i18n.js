...
export const STRINGS = {
  he: {
    ...
    avgBtn: "ממוצע שבועי",
    avgTitle: (name) => `${name} · ממוצע שבועי`,
    colTask: "משימה",
    colWeek: "השבוע",
    colAvg4: "ממוצע (4 שב׳)",
    avgFootNote: "עמודה ראשונה: השבוע. שנייה: ממוצע ל-4 השבועות האחרונים.",
    sortDesc: "מהגבוה לנמוך",
    sortAsc: "מהנמוך לגבוה",
    noAvgData: "עוד אין נתונים. חזרו אחרי כמה ימים.",
    anyDay: "כל יום",
    everyDay: "כל יום",
    days: ["א׳", "ב׳", "ג׳", "ד׳", "ה׳", "ו׳", "ש׳"],
    langBtn: "EN",
  ...
  en: {
    ...
    avgBtn: "Weekly avg",
    avgTitle: (name) => `${name} · weekly average`,
    colTask: "Task",
    colWeek: "This week",
    colAvg4: "Avg (4 wk)",
    avgFootNote: "First column: this week. Second: average per week over the last 4 weeks.",
    sortDesc: "High to low",
    sortAsc: "Low to high",
    noAvgData: "No data yet. Come back in a few days.",
    anyDay: "any day",
    everyDay: "every day",
